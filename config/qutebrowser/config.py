...
config.bind('ea', 'spawn sh -c "echo {url} | buku-db.sh -sfw -a"')
config.bind('eA', 'spawn sh -c "echo {url} | buku-db.sh -nsfw -a"')
config.bind('f', 'hint')
...
with Path(Path.home(), '.cache', 'wal', 'qutebrowser.yml').open() as f:
